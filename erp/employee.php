...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center">
        ...
        <?php if ($_SESSION['role_name'] === 'employee'): ?>
        <a class="btn btn-light btn-sm me-2" href="clients1.php">👥 Clients</a>
        <a class="btn btn-warning btn-sm me-2" href="suppliers1.php">🚚 Fournisseurs</a>
        <?php endif; ?>
